...
class ModuleServices
{
  ...
  {
    if ($v)
      $this->app->assets = array_merge ($this->app->assets, array_map (function ($path) {
  ...
  {
    $this->app->presets = array_merge ($v, $this->app->presets);
    return $this;
  }
  ...
  {
    $this->app->routes = array_merge ($v, $this->app->routes);
    return $this;
  }
