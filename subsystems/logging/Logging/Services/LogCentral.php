...
class LogCentral implements LogCentralInterface
{
  ...
  function assignFormattersToHandlers (array $map)
  {
    ...
    else $this->formattersToHandlers[] = $map;
    return $this;
  }
  ...
  public function connectHandlersToProcessors (array $map)
  {
    ...
    else $this->handlersToProcessors[] = $map;
    return $this;
  }
  ...
  function connectLoggersToHandlers (array $map)
  {
    ...
    else $this->loggersToHandlers[] = $map;
    return $this;
  }
  ...
  function connectLoggersToProcessors (array $map)
  {
    ...
    else $this->loggersToProcessors[] = $map;
    return $this;
  }
  ...
  {
    return new GroupHandler(map ($names, function ($name) { return $this->handler ($name); }));
  }
