...
interface NavigationLinkInterface extends \IteratorAggregate
{
  ...
  /**
   * Indicates if the link is actually enabled, taking into account `enabled()`, `visibleIfUnavailable()` and missing
   ...
   * @return $this|NavigationLinkInterface|NavigationInterface
   */
   ...
   *
   * <p>It is automatically set from the link's key on the navigation map that defines the link.
   *
   ...
   *
   * <p>You may explicitly override the value generated by default. The link's children URLs will be computed relatively
