...
class DataObject {
  ...
  public static $cacheObj = []; //array of singletons for all subclasses
    ...
    try {
      ...
      if (isset($this->fk)) {
        foreach ($this->fk as $fk) {
          ...
          $list = $data->queryBy("$fk->field=?",$data->primaryKeyName,null,[$this->getPrimaryKeyValue()])->fetchAll(PDO::FETCH_NUM);
